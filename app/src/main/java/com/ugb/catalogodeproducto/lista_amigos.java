...
public class lista_amigos extends AppCompatActivity {
            ...
            switch (item.getItemId()){
                ...
                case R.id.mnxModificar:
                    String amigos[] = {
                            ...
                            cAMigos.getString(1), //codigo del producto
                            cAMigos.getString(3), //descripcion
                            cAMigos.getString(4), //marca
                            cAMigos.getString(5), //presentacion
                            cAMigos.getString(2),
    ...
    void eliminarAmigos(){
        ...
        confirmacion.setPositiveButton("Si", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                db_producto.administrar_agenda(cAMigos.getString(0), "", "", "","",
                        "","eliminar");
                obtenerDatosAmigos();
    ...
    public void obtenerDatosAmigos(){
        try {
            alAmigos.clear();
            db_producto = new DB(lista_amigos.this, "", null, 1);
            cAMigos = db_producto.consultar_agenda();
